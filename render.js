...
function cardPropertyRows(card) {
  ...
  if (card.overhead)
    add('🔨', 'Из-за головы', 'играется только в ответ на удар с меткой «Высокий»; можно играть у сетки. Всегда бьётся как из позиции — 2 кубика без штрафа за бег, даже если свеча выбила вас из позиции.');
